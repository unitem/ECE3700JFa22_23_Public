...
HD_PWD='D:/campus/VE370/lab/lab6/lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CacheTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CacheTest.tcl -notrace
