...
HD_PWD='D:/campus/VE370/lab/lab6/lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CacheTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CacheTest.tcl
