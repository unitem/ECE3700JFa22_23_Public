...
HD_PWD='D:/campus/VE370/HW/HW2/problem8/problem8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reg_32.tcl -notrace
