...
HD_PWD='D:/campus/VE370/HW/HW2/problem8/problem8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reg_32.tcl
